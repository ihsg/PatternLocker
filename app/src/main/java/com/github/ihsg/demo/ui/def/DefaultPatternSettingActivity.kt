...
import com.github.ihsg.demo.databinding.ActivityDefaultPatternSettingBinding
...
class DefaultPatternSettingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ActivityDefaultPatternSettingBinding.inflate(layoutInflater).apply {
            setContentView(root)

            patternIndicatorView.updateState(listOf(1, 2), false)
